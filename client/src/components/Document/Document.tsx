...
import { VLayout, VFlex, VCard, VCardTitle, VCardText } from "vuetify-tsx";
...
const DocumentComponent = componentFactoryOf<Events, ScopedSlots>().create({
  props: {
    text: String
  },
  /**
  ...
  render(): VNode {
    ...
    return (
      <VCard>
        ...
        <VCardText class="heading grey--text">{documentCard()}</VCardText>
      </VCard>
    );
  }
});
